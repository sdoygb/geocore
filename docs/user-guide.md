...
Done: 45 features, 294 tests (incl. ~700 fuzz cases + real-data tests +
...
LiH molecule + input universality + relative plateau + noise-induced
barren plateaus + N-sector reduction), 12 measured shortcuts (see catalog).
